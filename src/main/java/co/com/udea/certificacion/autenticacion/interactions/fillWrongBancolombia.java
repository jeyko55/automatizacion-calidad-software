...
public class fillWrongBancolombia implements Interaction {
    @Override
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(JavaScriptClick.on(TEXT_AREA_CIUDAD_NO_DISPONIBLE));
    ...
    public static fillWrongBancolombia data(){
        return Tasks.instrumented(fillWrongBancolombia.class);
    }}
